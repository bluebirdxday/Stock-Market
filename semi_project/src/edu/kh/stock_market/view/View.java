...
public class View {
	...
	private void ruleView() {
		System.out.println("-  [기본 규칙 설명] -\r\n"
				+ "- 총 20턴(오전 오후 1턴 씩, 10일 동안 진행), 20턴 후 최종적으로 가장 많은 금액 보유자 승리합니다.\r\n"
				+ "- n명이 게임 시작 시 1주당 1만원 주식을 거래할 수 있습니다.\r\n"
				+ "- 주식 가격은 구매 중에도 실시간으로 변경됩니다.\r\n"
				+ "- 초기 자본 모두 10만원으로 시작합니다.\r\n"
				+ "- 주가는 상황에 따라 수시로 변동됩니다.(퍼센트)\r\n"
				+ "-(상승/하락은 10% 내외로)\r\n"
				+ "- 턴 마다 매수, 매도, 패스를  선택 할 수 있습니다.\r\n"
				+ "매수, 매도는 각 1번씩만 가능합니다.(총 2회)\r\n"
				+ "- 주식 수는 모두 10주씩으로 한정되어 있으며 \r\n"
				+ "종목 당 주식은 게임 중 유저 수 * 10주씩 발행됩니다.\r\n"
				+ "- 1턴당 한 유저의 매수 가능한 주식 수는 10주씩 한정되어 있습니다.\r\n"
				+ "- (코스피-코스닥 지수 표기(장이 좋을지 나쁠지 랜덤))\r\n\n"
				+ "-  [정보 설명] -\r\n"
				+ "- 주식장과 관련된 정보 입찰이 격일로 진행됩니다.\r\n"
